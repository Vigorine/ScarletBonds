...
import net.scarletbonds.procedures.TotalConcentrationBreathingConstantActiveProcedure;
...
public class TotalConcentrationBreathingConstantKeyKeyBinding extends ScarletBondsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public TotalConcentrationBreathingConstantKeyKeyBinding(ScarletBondsModElements instance) {
		super(instance, 248);
	...
	public void initElements() {
		keys = new KeyBinding("key.scarlet_bonds.total_concentration_breathing_constant_key", GLFW.GLFW_KEY_O, "key.categories.SlayerActives");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			TotalConcentrationBreathingConstantActiveProcedure.executeProcedure(Collections.emptyMap());
		}
	}
}
