...
import net.scarletbonds.procedures.TotalConcentrationBreathingActiveProcedure;
...
public class TotalConcentrationBreathingKeyKeyBinding extends ScarletBondsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public TotalConcentrationBreathingKeyKeyBinding(ScarletBondsModElements instance) {
		super(instance, 247);
	...
	public void initElements() {
		keys = new KeyBinding("key.scarlet_bonds.total_concentration_breathing_key", GLFW.GLFW_KEY_N, "key.categories.SlayerActives");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			TotalConcentrationBreathingActiveProcedure.executeProcedure(Collections.emptyMap());
		}
	}
}
