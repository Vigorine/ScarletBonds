...
import net.scarletbonds.procedures.DemonMarkActiveProcedure;
...
public class DemonMarkKeyKeyBinding extends ScarletBondsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public DemonMarkKeyKeyBinding(ScarletBondsModElements instance) {
		super(instance, 243);
	...
	public void initElements() {
		keys = new KeyBinding("key.scarlet_bonds.demon_mark_key", GLFW.GLFW_KEY_H, "key.categories.DemonActives");
