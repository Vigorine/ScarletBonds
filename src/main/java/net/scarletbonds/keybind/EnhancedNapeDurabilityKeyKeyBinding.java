...
import net.scarletbonds.procedures.EnhancedNapeDurabilityActiveProcedure;
...
public class EnhancedNapeDurabilityKeyKeyBinding extends ScarletBondsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public EnhancedNapeDurabilityKeyKeyBinding(ScarletBondsModElements instance) {
		super(instance, 246);
	...
	public void initElements() {
		keys = new KeyBinding("key.scarlet_bonds.enhanced_nape_durability_key", GLFW.GLFW_KEY_M, "key.categories.DemonActives");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			EnhancedNapeDurabilityActiveProcedure.executeProcedure(Collections.emptyMap());
		}
	}
}
