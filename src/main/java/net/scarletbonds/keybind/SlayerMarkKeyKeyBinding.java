...
import net.scarletbonds.procedures.SlayerMarkActiveProcedure;
...
public class SlayerMarkKeyKeyBinding extends ScarletBondsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public SlayerMarkKeyKeyBinding(ScarletBondsModElements instance) {
		super(instance, 249);
	...
	public void initElements() {
		keys = new KeyBinding("key.scarlet_bonds.slayer_mark_key", GLFW.GLFW_KEY_U, "key.categories.SlayerActives");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			SlayerMarkActiveProcedure.executeProcedure(Collections.emptyMap());
		}
	}
}
