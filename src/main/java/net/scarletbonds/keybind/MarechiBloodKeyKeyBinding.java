...
import net.scarletbonds.procedures.MarechiBloodActiveProcedure;
...
public class MarechiBloodKeyKeyBinding extends ScarletBondsModElements.ModElement {
	...
	public MarechiBloodKeyKeyBinding(ScarletBondsModElements instance) {
		super(instance, 250);
	...
	public void initElements() {
		keys = new KeyBinding("key.scarlet_bonds.marechi_blood_key", GLFW.GLFW_KEY_V, "key.categories.SlayerActives");
