...
import net.scarletbonds.procedures.KakushiActiveProcedure;
...
public class KakushiKeyKeyBinding extends ScarletBondsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public KakushiKeyKeyBinding(ScarletBondsModElements instance) {
		super(instance, 251);
	...
	public void initElements() {
		keys = new KeyBinding("key.scarlet_bonds.kakushi_key", GLFW.GLFW_KEY_BACKSLASH, "key.categories.SlayerActives");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			KakushiActiveProcedure.executeProcedure(Collections.emptyMap());
		}
	}
}
