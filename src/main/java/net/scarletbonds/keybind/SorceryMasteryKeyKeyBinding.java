...
import net.scarletbonds.procedures.SorceryMasteryActiveProcedure;
...
public class SorceryMasteryKeyKeyBinding extends ScarletBondsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public SorceryMasteryKeyKeyBinding(ScarletBondsModElements instance) {
		super(instance, 244);
	...
	public void initElements() {
		keys = new KeyBinding("key.scarlet_bonds.sorcery_mastery_key", GLFW.GLFW_KEY_J, "key.categories.DemonActives");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			SorceryMasteryActiveProcedure.executeProcedure(Collections.emptyMap());
		}
	}
}
