...
package net.scarletbonds.world.dimension;
...
public class BuildersForgeDimension extends ScarletBondsModElements.ModElement {
	public BuildersForgeDimension(ScarletBondsModElements instance) {
		super(instance, 260);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("scarlet_bonds:white_super_flat")).getGenerationSettings()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("scarlet_bonds:builders_forge"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
